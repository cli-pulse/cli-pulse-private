...
// terminal WebView: the macOS TerminalView AND the iOS RemoteTerminalView
// (retired in v1.52.1, restored for remote-control M0). Both load the
// vendored xterm.js bundle and nothing else; this is what enforces it.
//
